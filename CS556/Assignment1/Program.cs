...
namespace Assignment1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(graph.HasVertex(new Vertex<int,int>() { Label = vertex2.Label })); // True
            graph.AddVertex(new Vertex<int,int>() { Label = 2 }, 2);
            ...
            var vertex3 = new Vertex<int,int>() { Label = 2 };
            ...
            var vertex4 = new Vertex<int,int>() { Label = 22 };
            var vertex5 = new Vertex<int,int>() { Label = 23 };
