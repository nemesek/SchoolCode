...
namespace Assignment1
{
    public class Digraph<Tvertex, Tvlabel, Telabel>
    {
        ...
        public Digraph<Tvertex, Tvlabel, Telabel> RemoveVertex(Vertex<Tvertex, Tvlabel> vertex)
        {
            ...
            if (vertexToRemove == null) throw new ArgumentException(string.Format("Vertex Id {0} is not an element within this graph's vertex set", vertex.Identifier));
            var updatedVerticesList = _vertices.ToList();
        ...
        public Digraph<Tvertex, Tvlabel, Telabel> UpdateVertex(Vertex<Tvertex, Tvlabel> vertex, Tvlabel label)
        {
            ...
            if (vertexToUpdate == null) throw new ArgumentException(string.Format("Vertex Id {0} is not an element within this graph's vertex set", vertex.Identifier));
        ...
        public Tvlabel GetVertex(Vertex<Tvertex, Tvlabel> vertex)
        {
            ...
            if (vertexToGet == null) throw new ArgumentException(string.Format("Vertex Id {0} is not an element within this graph's vertex set", vertex.Identifier));
        ...
        public Digraph<Tvertex, Tvlabel, Telabel> AddEdge(Vertex<Tvertex, Tvlabel> vertex1, Vertex<Tvertex, Tvlabel> vertex2, Telabel label)
        {
            ...
            if (source == null)  throw new ArgumentException(string.Format("Vertex Id {0} is not an element within this graph's vertex set", vertex1.Identifier));

            var destination = this.GetVertex(vertex2.Identifier);
            if (destination == null) throw new ArgumentException(string.Format("Vertex Id {0} is not an element within this graph's vertex set", vertex2.Identifier));
        ...
        public Digraph<Tvertex, Tvlabel, Telabel> RemoveEdge(Vertex<Tvertex, Tvlabel> vertex1, Vertex<Tvertex, Tvlabel> vertex2)
        {
            ...
            if (edgeToRemove == null) throw new ArgumentException(string.Format("Edge from vertex {0} to {1} is not an element within this graph's edge set", vertex1.Identifier, vertex2.Identifier));
        ...
        public Digraph<Tvertex, Tvlabel, Telabel> UpdateEdge(Vertex<Tvertex, Tvlabel> vertex1, Vertex<Tvertex, Tvlabel> vertex2, Telabel label)
        {
            ...
            if (edgeToUpdate == null) throw new ArgumentException(string.Format("Edge from vertex {0} to {1} is not an element within this graph's edge set", vertex1.Identifier, vertex2.Identifier));
        ...
        public Telabel GetEdge(Vertex<Tvertex, Tvlabel> vertex1, Vertex<Tvertex, Tvlabel> vertex2)
        {
            ...
            if (edge == null) throw new ArgumentException(string.Format("Edge from vertex {0} to {1} is not an element within this graph's edge set", vertex1.Identifier, vertex2.Identifier));
            return edge.Label;
        }
